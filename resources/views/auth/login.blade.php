...
<body class="bg-gray-100">
    <div class="min-h-screen flex items-center justify-center">
        <div class="max-w-md w-full space-y-8">
            ...
            <form class="mt-8 space-y-6" action="{{ route('backend.login') }}" method="POST">
                @csrf
            ...
            <div class="mt-6 bg-blue-50 p-4 rounded-lg">
                ...
                <p class="text-sm text-blue-700 mt-1"><strong>Email:</strong> admin@gmail.com</p>
                <p class="text-sm text-blue-700"><strong>Password:</strong> asdasd</p>
            </div>
        </div>
    </div>
</body>
